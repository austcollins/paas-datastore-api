...
| ---- | ------ | ---------- | ------------ | ----------- | --------- | ------------- |
| / | GET | /{id} | None | reads the value of a names register | 200 - text/plain, 500 - Internal Error | text/plain |
| / | PUT | /{id} | text/plain | sets a names register to a given number | 20s0 - text/plain, 500 - Internal Error | text/plain |
| / | POST | /{id} | text/plain | adds a number to a names register | 200 - text/plain, 500 - Internal Error | text/plain |
